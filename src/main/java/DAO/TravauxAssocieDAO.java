...
public interface TravauxAssocieDAO {
    ...
    /**
     * Associe un nouveau devis à un bien louable dans la base de donnees.
     * @param num_fiscal le numero fiscal du bien louable
     * @param devis le devis à associer
     * @param typeLogement le type de logement
     * @throws DAOException en cas d'erreur lors de la creation de l'association
     */
    void create(String num_fiscal, Devis devis, TypeLogement typeLogement) throws DAOException;

    /**
     * Recupère tous les id des devis d'un bien louable dans la base de donnees.
     * @param num_fiscal le numero fiscal du bien louable
     * @param typeLogement le type de logement
    ...
    /**
     * Recupère tous les id des devis d'un bien en fonction d'une date
    ...
    /**
     * Supprime une association entre un devis et un bien louable dans la base de donnees.
