    ...
    public ActionListener getAjouterLocataireListener() {
        return e -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Le locataire a bien été ajouté !", "Succès",
                ...
                PageNouveauLocataire nouvellePage = new PageNouveauLocataire(); // Remplacez par le constructeur de
                                                                                // votre page
                nouvellePage.getFrame().setVisible(true);
            } catch (SQLException e1) {
                // TODO Auto-generated catch block
                e1.printStackTrace();
                JOptionPane.showMessageDialog(null, "Erreur dans la saisie d'information", "Erreur de saisie",
