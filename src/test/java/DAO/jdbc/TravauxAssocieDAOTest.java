...
public class TravauxAssocieDAOTest {
    ...
    public void setUp() throws SQLException, DAOException {
        ...
        bienLouable = new BienLouable("123456789102", "Paris", "123 Rue de la Paix", "Complment", new ArrayList<>(), null, TypeLogement.APPARTEMENT);
    ...
    public void testFindAllForBatiment() throws DAOException {
        Batiment batiment = new Batiment("123456789103", "Lyon", "456 Rue de la Libert", "69000");
        BatimentDAO batimentDAO = new BatimentDAO();
        batimentDAO.create(batiment);
        Devis devisBatiment = new Devis("123456789016", "F123456789016", 2000.0f, "Construction", 300.0f, Date.valueOf("2024-02-01"), Date.valueOf("2024-07-01"), "TypeB", "456 Rue de la Libert", "Entreprise B");
    ...
    public void testFindAllForGarage() throws DAOException {
        ...
        Devis devisGarage = new Devis("123456789017", "F123456789017", 1500.0f, "Rparation", 250.0f, Date.valueOf("2024-03-01"), Date.valueOf("2024-08-01"), "TypeC", "789 Rue de la Mer", "Entreprise C");
    ...
    public void testFindAllForMaison() throws DAOException {
        BienLouable maison = new BienLouable("123456789108", "Paris", "123 Rue de la Paix", "Complment", new ArrayList<>(), null, TypeLogement.MAISON);
