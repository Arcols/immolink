...
public class PageEditProfil {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					PageEditProfil window = new PageEditProfil();
	...
	private void initialize() {
		...
		this.frame.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				ResizedImage.resizeImage("/ressources/images/logo+nom.png", PageEditProfil.this.frame,
						PageEditProfil.this.logo, 3, 8);
				int frameWidth = PageEditProfil.this.frame.getWidth();
				int frameHeight = PageEditProfil.this.frame.getHeight();
