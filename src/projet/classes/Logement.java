...
public class Logement extends BienLouable {
	...
	public Logement(int nb_piece, double surface, String numero_fiscal, String complement_adresse, Batiment batiment,
	...
	public Logement(int nb_piece, double surface, Garage garage, String numero_fiscal, String complement_adresse,
			Batiment batiment, List<Diagnostic> diagnostic) {
		super(numero_fiscal, complement_adresse, batiment, diagnostic);
		if (surface < 9) {
			throw new IllegalArgumentException(" Un logement fait au minimum 9m²");
		}
	...
	private void insertIntoTable(int nb_piece, double surface, Garage garage, String numero_fiscal,
